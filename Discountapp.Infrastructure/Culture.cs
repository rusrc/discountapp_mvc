...
namespace Discountapp.Infrastructure
{
    public class Culture
    {
        ...
        private static readonly List<string> Cultures =
            new List<string> {"ru-Ru", "en", "de", "kk", "uk", "he", "hy-AM"};
        /// <summary>
        /// One like of "ru-Ru", "en", "de", "kk", "uk", "he", "hy-AM"
        /// </summary>
        public static string DefaultCulture => Cultures[0];

        /// <summary>
        ///     Систем письма с права на лево или наоборот
        /// </summary>
        ...
        /// <summary>
        ///     Проверяет на валидность параметр "name", если не валидно вернет ru-RU
        /// </summary>
